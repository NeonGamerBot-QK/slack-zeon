...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `NeonGamerBot-QK`, `slack-zeon`, `twitter_handle`, `linkedin_username`, `project_title`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/NeonGamerBot-QK/slack-zeon.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin NeonGamerBot-QK/slack-zeon
...
See the [open issues](https://github.com/NeonGamerBot-QK/slack-zeon/issues) for a full list of proposed features (and known issues).
