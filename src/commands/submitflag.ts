...
if(secrets.find(e=>e.matches == validKey.to_next).ch_id) {
    ...
    await app.client.chat.postEphemeral({
        ...
        text: validKey.message || `:white_check_mark: Flag submitted successfully. You can find your flag in the next channel <#${secrets.find(e=>e.matches == validKey.to_next)?.ch_id}>`
    })
} else {
