...
// const res = []
// lil chat moment
if (!Array.isArray(json) || json.length < 4 || typeof json[3] !== 'object') return null;
...
return fetch('https://rpg.hackclub.com/leaderboard', {
    ...
    return (parseScriptMoment(scriptTags.find(e=>e.includes("Leaderboard")).split("</script>")[0].split("\\").join("")))
  })
}
