...
export const Shop = [
  ...
  },
  {
    ...
    imageUrl:
      "https://noras-secret-cdn.hackclub.dev/shop/card_grant_digitalocean.png",
    enabledUs: true,
    enabledEu: true,
    enabledIn: true,
    enabledXx: true,
  ...
  },
  {
    ...
    subtitle:
      '<a target="_blank" href="https://shop.mitutoyo.eu/web/mitutoyo/en/mitutoyo/PR/500-193-30/datasheet.xhtml"><u>digimatic</u>! i\'m a fanatic!!',
    imageUrl:
      "https://noras-secret-cdn.hackclub.dev/shop/really_nice_calipers.png",
    enabledUs: true,
    enabledEu: false,
    enabledIn: false,
    enabledXx: false,
  ...
  },
  {
    ...
    subtitle:
      "visit scenic vermont!<br/><del>come bug me about shop prices in-person!!</del>",
