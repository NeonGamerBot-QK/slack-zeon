...
export function getShips(): Promise<Ship[]> {
    return fetch("https://journey.hackclub.com/api/v1/projects").then(r=>r.json())
}
export function getUpdates(): Promise<Update[]> {
    return fetch("https://journey.hackclub.com/api/v1/updates").then(r=>r.json())
}
export function getComments(): Promise<Comment[]> {
    return fetch("https://journey.hackclub.com/api/v1/comments").then(r=>r.json())
}
